...
if(isset($_POST['update'])) {
    ...
    $query = "UPDATE user SET username='$username', password='$password', domisili='$domisili' WHERE id=$id";
...
<div class="container">
        ...
        <input type="text" id="domisili" name="domisili" value="<?php echo $data['domisili']; ?>"><br><br>
